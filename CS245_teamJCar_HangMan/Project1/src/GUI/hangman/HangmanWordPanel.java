...
public class HangmanWordPanel extends JPanel {
    ...
    //this method sets the word length 
    //according to number parameter it receives
    ...
    //returns the current letter of the word
    public char[] getLetters() {
        return mLetters;
    }
    //sets the character of the word in the index of the word array
    ...
    //creates the keyboard panel and display of the word in the hangman game
    @Override
